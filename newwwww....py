...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            text_screen("Game Over! Press Enter To Continue & e to exit game",white, 115, 420) ##########################################

            text_screen("Your score : "+ str(score),white,500,465)
            text_screen("Hiscore : " +str(hiscore), white, 500, 505)
